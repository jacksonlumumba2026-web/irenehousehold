...
function openQuickView(id) {
  ...
  if (imgs.length > 1) {
    ...
    imgs.forEach(function(src, i) {
      ...
      th.style.cssText = 'width:52px;height:52px;flex-shrink:0;object-fit:cover;border-radius:7px;cursor:pointer;border:2.5px solid '+(i===0?'#1a3d2b':'#e0e0e0')+';transition:border-color .15s;';
